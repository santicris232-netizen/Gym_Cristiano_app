...
const variants: Record<Variant, string> = {
  ...
  danger: "bg-usa-red text-cream border border-usa-red hover:shadow-[0_0_18px_rgba(179,36,42,0.5)]",
  ghost: "bg-transparent text-cream-dim border border-transparent hover:text-cream hover:border-line",
};
