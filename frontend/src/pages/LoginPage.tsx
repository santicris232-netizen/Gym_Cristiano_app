...
export function LoginPage() {
  return (
    <>
      <h2 className="mb-1 font-display text-xl tracking-wide text-cream">Iniciar sesión</h2>
      ...
      <p className="mt-6 text-center text-sm text-cream-dim">
        ¿Primera vez por acá?{" "}
        <Link to="/registro" className="font-semibold text-neon-blue hover:underline">
          Crea tu cuenta
        </Link>
      </p>
